...
reference_url: https://ersanio.gitbook.io/assembly-for-the-snes/mathemathics-and-logic/arithmetic
categories:
  - "Documentation"
downloaded_at: 2026-02-13T20:24:16-08:00
---
...
## [hashtag](#inc-and-dec) INC and DEC
...
## [hashtag](#inx-dex-iny-and-dey) INX, DEX, INY and DEY
...
## [hashtag](#adc-and-sbc) ADC and SBC
...
### [hashtag](#overflow-flag) Overflow flag
...
## [hashtag](#id-16-bit-mode-math) 16-bit mode math

All the previous explanations and behaviours apply to 16-bit math as well.

[PreviousStack pointer register](/assembly-for-the-snes/processor-flags-and-registers/stackpointer)[NextBit shifting operations](/assembly-for-the-snes/mathemathics-and-logic/shift)
