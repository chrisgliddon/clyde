...
In this tutorial we cover initializing the Super Nintendo and changing the background to a beautiful shade of green. Uses WLA-DX syntax — compare with our ca65 approach in `lib/init.s`.

## Required Tools

- The [WLA-65816 Macro Assembler](http://www.villehelin.com/wla.html)
- A SNES emulator such as [Mesen2](https://www.mesen.ca/) or [bsnes](http://byuu.org/bsnes/)
...
Here, we force VBlank by turning off the screen:
...
Unlike many computer programs, SNES programs aren't really designed to end. SNES games are intended to keep running until the user turns the system off or presses reset. We accomplish this with an infinite loop:
