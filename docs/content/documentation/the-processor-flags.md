---
title: "The processor flags"
reference_url: https://ersanio.gitbook.io/assembly-for-the-snes/processor-flags-and-registers/flags
categories:
  - "Documentation"
downloaded_at: 2026-02-13T20:23:52-08:00
---
...
## [hashtag](#negative-flag-n) Negative flag (n)
...
## [hashtag](#overflow-flag-v) Overflow flag (v)

There are 3 opcodes which affect the overflow flag after a calculation: [`ADC`, `SBC`](/assembly-for-the-snes/mathemathics-and-logic/arithmetic) and [`BIT`](/assembly-for-the-snes/mathemathics-and-logic/logic). For detailed explanations of when the overflow flag is set, see the links.
...
## [hashtag](#memory-select-m) Memory select (m)
...
## [hashtag](#index-select-x) Index select (x)
...
## [hashtag](#decimal-mode-flag-d) Decimal mode flag (d)
...
### [hashtag](#binary-coded-decimal) Binary-coded decimal
...
## [hashtag](#interrupt-disable-flag-i) Interrupt disable flag (i)
...
## [hashtag](#zero-flag-z) Zero flag (z)
...
## [hashtag](#carry-flag-c) Carry flag (c)
...
## [hashtag](#emulation-mode-flag-e) Emulation mode flag (e)
...
### [hashtag](#processor-flags) Processor flags
...
### [hashtag](#unused-flag) Unused flag

This processor flag is unused and is always set to 1.

### [hashtag](#break-flag) Break flag
...
[PreviousCopying data](/assembly-for-the-snes/collection-of-values/moves)[NextChanging the processor flags](/assembly-for-the-snes/processor-flags-and-registers/repsep)
