...
B58096:
    ...
    %AICMD0x15_JumpIfEquals8($800924, 2, $B580DE)              ;B5809C
    %AICMD0x16_JumpIfBetween8($800924, 1, 5, $B580EB)          ;B580A3
    %AICMD0x15_JumpIfEquals8($800924, 7, $B580EB)              ;B580AB
    %AICMD0x16_JumpIfBetween8($800924, 16, 23, $B580EB)        ;B580B2
    %AICMD0x15_JumpIfEquals8($800924, 25, $B580FF)             ;B580BA
    %AICMD0x15_JumpIfEquals8($800924, 73, $B580FF)             ;B580C1
    %AICMD0x15_JumpIfEquals8($800924, 6, $B58120)              ;B580C8
    %AICMD0x16_JumpIfBetween8($800924, 9, 12, $B58113)         ;B580CF
...
B5815C:
    ...
    %AICMD0x15_JumpIfEquals8($800992, 3, $B582A3)              ;B58180
...
B58550:
    ...
    %AICMD0x15_JumpIfEquals8($800924, 2, $B58591)              ;B58556
    %AICMD0x16_JumpIfBetween8($800924, 3, 5, $B585B2)          ;B5855D
    %AICMD0x16_JumpIfBetween8($800924, 16, 23, $B585B2)        ;B58565
    %AICMD0x15_JumpIfEquals8($800924, 6, $B585D3)              ;B5856D
    %AICMD0x15_JumpIfEquals8($800924, 25, $B5859E)             ;B58574
    %AICMD0x15_JumpIfEquals8($800924, 73, $B5859E)             ;B5857B
    %AICMD0x16_JumpIfBetween8($800924, 9, 12, $B585C6)         ;B58582
...
B5860F:
    ...
    %AICMD0x15_JumpIfEquals8($800992, 3, $B58756)              ;B58633
...
B58A06:
    ...
    %AICMD0x16_JumpIfBetween8($800924, 1, 4, $B58A68)          ;B58A0C
    %AICMD0x16_JumpIfBetween8($800924, 16, 23, $B58A68)        ;B58A14
    %AICMD0x16_JumpIfBetween8($800924, 9, 12, $B58A9E)         ;B58A1C
    %AICMD0x15_JumpIfEquals8($800924, 6, $B58A7C)              ;B58A24
    %AICMD0x15_JumpIfEquals8($800924, 5, $B58A7C)              ;B58A2B
    %AICMD0x15_JumpIfEquals8($800924, 25, $B58A47)             ;B58A32
    %AICMD0x15_JumpIfEquals8($800924, 73, $B58A54)             ;B58A39
...
B58AC5:
    ...
    %AICMD0x15_JumpIfEquals8($800992, 3, $B58C14)              ;B58AE9
...
B58EC4:
    ...
    %AICMD0x15_JumpIfEquals8($800924, 2, $B58F0D)              ;B58ECA
    %AICMD0x16_JumpIfBetween8($800924, 1, 7, $B58F1A)          ;B58ED1
    %AICMD0x15_JumpIfEquals8($800924, 25, $B58F2E)             ;B58ED9
    %AICMD0x15_JumpIfEquals8($800924, 73, $B58F2E)             ;B58EE0
    %AICMD0x15_JumpIfEquals8($800924, 6, $B58F5C)              ;B58EE7
    %AICMD0x16_JumpIfBetween8($800924, 16, 19, $B58F1A)        ;B58EEE
    %AICMD0x16_JumpIfBetween8($800924, 20, 23, $B58F42)        ;B58EF6
    %AICMD0x16_JumpIfBetween8($800924, 9, 12, $B58F4F)         ;B58EFE
...
B58F92:
    ...
    %AICMD0x15_JumpIfEquals8($800992, 3, $B590D9)              ;B58FB6
...
B59389:
    ...
    %AICMD0x15_JumpIfEquals8($800924, 2, $B593D1)              ;B5938F
    %AICMD0x15_JumpIfEquals8($800924, 7, $B593D1)              ;B59396
    %AICMD0x16_JumpIfBetween8($800924, 1, 5, $B593DE)          ;B5939D
    %AICMD0x16_JumpIfBetween8($800924, 16, 23, $B593DE)        ;B593A5
    %AICMD0x15_JumpIfEquals8($800924, 6, $B593F2)              ;B593AD
    %AICMD0x15_JumpIfEquals8($800924, 25, $B59406)             ;B593B4
    %AICMD0x15_JumpIfEquals8($800924, 73, $B59406)             ;B593BB
    %AICMD0x16_JumpIfBetween8($800924, 9, 12, $B59428)         ;B593C2
...
B5944F:
    ...
    %AICMD0x15_JumpIfEquals8($800992, 3, $B59596)              ;B59473
...
B59836:
    ...
    %AICMD0x15_JumpIfEquals8($800924, 2, $B59880)              ;B5983E
    %AICMD0x16_JumpIfBetween8($800924, 1, 5, $B5988D)          ;B59845
    %AICMD0x15_JumpIfEquals8($800924, 7, $B5988D)              ;B5984D
    %AICMD0x16_JumpIfBetween8($800924, 16, 23, $B5988D)        ;B59854
    %AICMD0x15_JumpIfEquals8($800924, 25, $B598A1)             ;B5985C
    %AICMD0x15_JumpIfEquals8($800924, 73, $B598A1)             ;B59863
    %AICMD0x15_JumpIfEquals8($800924, 6, $B598C2)              ;B5986A
    %AICMD0x16_JumpIfBetween8($800924, 9, 12, $B598B5)         ;B59871
...
B598FE:
    ...
    %AICMD0x15_JumpIfEquals8($800992, 3, $B59968)              ;B59912
...
B59A34:
    ...
    %AICMD0x15_JumpIfEquals8($800924, 2, $B59A77)              ;B59A3C
    %AICMD0x16_JumpIfBetween8($800924, 3, 7, $B59A98)          ;B59A43
    %AICMD0x16_JumpIfBetween8($800924, 16, 23, $B59A98)        ;B59A4B
    %AICMD0x15_JumpIfEquals8($800924, 6, $B59AAC)              ;B59A53
    %AICMD0x15_JumpIfEquals8($800924, 25, $B59A84)             ;B59A5A
    %AICMD0x15_JumpIfEquals8($800924, 73, $B59A84)             ;B59A61
    %AICMD0x16_JumpIfBetween8($800924, 9, 12, $B59A77)         ;B59A68
...
B59AE8:
    ...
    %AICMD0x15_JumpIfEquals8($800992, 3, $B59B52)              ;B59AFC
...
B59C28:
    ...
    %AICMD0x16_JumpIfBetween8($800924, 1, 4, $B59C8C)          ;B59C30
    %AICMD0x16_JumpIfBetween8($800924, 16, 23, $B59C8C)        ;B59C38
    %AICMD0x16_JumpIfBetween8($800924, 9, 12, $B59CA0)         ;B59C40
    %AICMD0x15_JumpIfEquals8($800924, 6, $B59CAD)              ;B59C48
    %AICMD0x15_JumpIfEquals8($800924, 5, $B59CAD)              ;B59C4F
    %AICMD0x15_JumpIfEquals8($800924, 25, $B59C6B)             ;B59C56
    %AICMD0x15_JumpIfEquals8($800924, 73, $B59C78)             ;B59C5D
...
B59CE9:
    ...
    %AICMD0x15_JumpIfEquals8($800992, 3, $B59D50)              ;B59CFD
...
B59E10:
    ...
    %AICMD0x15_JumpIfEquals8($800924, 2, $B59E5B)              ;B59E18
    %AICMD0x16_JumpIfBetween8($800924, 1, 7, $B59E68)          ;B59E1F
    %AICMD0x16_JumpIfBetween8($800924, 16, 19, $B59E68)        ;B59E27
    %AICMD0x15_JumpIfEquals8($800924, 25, $B59E7C)             ;B59E2F
    %AICMD0x15_JumpIfEquals8($800924, 73, $B59E7C)             ;B59E36
    %AICMD0x15_JumpIfEquals8($800924, 6, $B59EAA)              ;B59E3D
    %AICMD0x16_JumpIfBetween8($800924, 20, 23, $B59E90)        ;B59E44
    %AICMD0x16_JumpIfBetween8($800924, 9, 12, $B59E9D)         ;B59E4C
...
B59EE0:
    ...
    %AICMD0x15_JumpIfEquals8($800992, 3, $B59F47)              ;B59EF4
...
B5A017:
    ...
    %AICMD0x15_JumpIfEquals8($800924, 2, $B5A061)              ;B5A01F
    %AICMD0x15_JumpIfEquals8($800924, 7, $B5A061)              ;B5A026
    %AICMD0x16_JumpIfBetween8($800924, 1, 5, $B5A06E)          ;B5A02D
    %AICMD0x16_JumpIfBetween8($800924, 16, 23, $B5A06E)        ;B5A035
    %AICMD0x15_JumpIfEquals8($800924, 6, $B5A082)              ;B5A03D
    %AICMD0x15_JumpIfEquals8($800924, 25, $B5A096)             ;B5A044
    %AICMD0x15_JumpIfEquals8($800924, 73, $B5A096)             ;B5A04B
    %AICMD0x16_JumpIfBetween8($800924, 9, 12, $B5A0B8)         ;B5A052
...
B5A0DF:
    ...
    %AICMD0x15_JumpIfEquals8($800992, 3, $B5A146)              ;B5A0F3
...
B5A21B:
    ...
    %AICMD0x15_JumpIfEquals8($800924, 6, $B5A26A)              ;B5A254
    %AICMD0x16_JumpIfBetween8($800924, 9, 12, $B5A292)         ;B5A25B
...
B5A49A:
    ...
    %AICMD0x15_JumpIfEquals8($800924, 6, $B5A4E9)              ;B5A4D3
    %AICMD0x16_JumpIfBetween8($800924, 9, 12, $B5A511)         ;B5A4DA
...
DATA8_B5AD25:
    ...
    %AICMD0x47_SetValue8($800927, 3)                           ;B5AD25
    %AICMD0x47_SetValue8($800929, 4)                           ;B5AD2A
...
DATA8_B5B050:
    ...
    %AICMD0x47_SetValue8($800927, 2)                           ;B5B176
    %AICMD0x47_SetValue8($800929, 12)                          ;B5B17B
...
DATA8_B5B2B8:
    ...
    %AICMD0x47_SetValue8($800927, 8)                           ;B5B44A
    %AICMD0x47_SetValue8($800929, 16)                          ;B5B44F
...
DATA8_B5B501:
    ...
    %AICMD0x47_SetValue8($800927, 0)                           ;B5B693
    %AICMD0x47_SetValue8($800929, 0)                           ;B5B698
...
DATA8_B5B87B:
    ...
    %AICMD0x47_SetValue8($800927, 1)                           ;B5BA25
    %AICMD0x47_SetValue8($800929, 18)                          ;B5BA2A
...
DATA8_B5BC45:
    ...
    %AICMD0x47_SetValue8($800927, 5)                           ;B5BE8B
    %AICMD0x47_SetValue8($800929, 6)                           ;B5BE90
...
DATA8_B5BF1A:
    ...
    %AICMD0x47_SetValue8($800927, 21)                          ;B5C160
    %AICMD0x47_SetValue8($800929, 0)                           ;B5C165
...
DATA8_B5C1BD:
    ...
    %AICMD0x47_SetValue8($800927, 0)                           ;B5C403
    %AICMD0x47_SetValue8($800929, 0)                           ;B5C408
...
DATA8_B5C4BA:
    ...
    %AICMD0x47_SetValue8($800927, 15)                          ;B5C4BA
    %AICMD0x47_SetValue8($800929, 14)                          ;B5C4BF
...
DATA8_B5C679:
    ...
    %AICMD0x47_SetValue8($800927, 11)                          ;B5C679
...
DATA8_B5CAA2:
    ...
    %AICMD0x47_SetValue8($800927, 4)                           ;B5CAA7
